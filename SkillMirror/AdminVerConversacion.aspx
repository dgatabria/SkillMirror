<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="AdminVerConversacion.aspx.cs" Inherits="SkillMirror.AdminVerConversacion" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="d-flex justify-content-between align-items-center pt-3 pb-2 mb-3 border-bottom">
        <div>
            ...
            <small class="text-muted"><asp:Literal ID="litUsuarioConversacion" runat="server"></asp:Literal></small>
        </div>
        <asp:HyperLink ID="btnVolver" runat="server" NavigateUrl="~/AdminConversaciones.aspx" CssClass="btn btn-outline-secondary"></asp:HyperLink>
    </div>
